...
const translations = {
  en: {
    ...
    'hero.title.part1': "Hi, I'm Honore",
    ...
    'about.bio': "A motivated developer focused on mastering scalable digital ecosystems. I believe that true innovation starts with solid fundamentals and professional-grade engineering.",
    'about.contact': 'Contact Me',
    'about.location': 'Location',
    'about.role': 'Current Path',
    'about.role.value': 'Junior Full-Stack Dev',
    'about.location.value': 'Remote / Global',
    'about.experience.title': 'Learning Path',
    'about.specializations.title': 'Academic Focus',
    'about.specializations.self.title': 'Self-Taught & Academic',
    'about.specializations.self.desc': 'Combining formal computer science education with continuous self-learning. I reinforce every concept through practical projects and real-world implementations rather than theory alone.',
    'about.specializations.junior.title': 'Open to Junior Roles',
    'about.specializations.junior.desc': 'Currently seeking a junior developer role or internship opportunity. Comfortable working in collaborative environments with Git workflows, code reviews, and team-based development practices.',
    'about.specializations.growth.title': 'Always Growing',
    'about.specializations.growth.desc': 'Currently expanding my skills in Next.js, Docker, and PostgreSQL while maintaining a personal learning workflow centered around hands-on side projects and experimentation.',
    // Contact
  ...
  fr: {
    ...
    'hero.title.part1': 'Salut, je suis Honore',
    ...
    'about.bio': "Développeur motivé axé sur la maîtrise des écosystèmes numériques évolutifs. Je crois que la véritable innovation commence par des bases solides.",
    'about.contact': 'Me Contacter',
    'about.location': 'Lieu',
    'about.role': 'Parcours Actuel',
    'about.role.value': 'Développeur Full-Stack Jr.',
    'about.location.value': 'À Distance / Global',
    'about.experience.title': 'Parcours d\'apprentissage',
    'about.specializations.title': 'Focus Académique',
    'about.specializations.self.title': 'Autodidacte & Académique',
    'about.specializations.self.desc': "Combinaison d'une formation informatique formelle et d'un apprentissage autonome continu. Je consolide chaque concept via des projets pratiques et des implémentations réelles plutôt que par la théorie seule.",
    'about.specializations.junior.title': 'Ouvert aux postes Junior',
    'about.specializations.junior.desc': "À la recherche d'un poste de développeur junior ou d'un stage. À l'aise dans des environnements collaboratifs avec des workflows Git, des revues de code et des pratiques de développement en équipe.",
    'about.specializations.growth.title': 'Toujours en croissance',
    'about.specializations.growth.desc': "Expansion continue de mes compétences en Next.js, Docker et PostgreSQL, avec un workflow d'apprentissage personnel axé sur des projets pratiques et l'expérimentation.",
    // Contact
