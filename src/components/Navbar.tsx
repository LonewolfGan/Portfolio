      ...
      >
        ...
        <div className="hidden md:flex items-center gap-2 px-6 py-2 pointer-events-auto glass rounded-full shadow-2xl backdrop-blur-xl">
          <Link to="/" className="flex items-center gap-3 group shrink-0">
            <div className="w-8 h-8 bg-gradient-to-tr from-primary to-emerald-600 rounded-lg flex items-center justify-center text-background font-display font-bold text-sm">
              A
            </div>
