      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-display font-clash font-bold text-foreground tracking-tight leading-none mb-4">
          ...
          <div className="shrink-0">
            ...
            >
              {/* Replace href with the actual PDF link when ready */}
          ...
          >
            ...
            <div className="space-y-6">
              {experience.map((exp, idx) => (
                <div key={idx} className="glass border border-border rounded-2xl p-7">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {projects.map((project) => (
                <div key={project.title} className="glass border border-border rounded-2xl p-6 hover:border-primary/20 transition-all group">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    <div className="flex gap-2">
                      <a href={project.link} target="_blank" rel="noopener noreferrer"
                        className="text-foreground/30 hover:text-primary transition-colors" aria-label="Live">
                        <ExternalLink size={14} />
                      </a>
                      <a href={project.github} target="_blank" rel="noopener noreferrer"
                        className="text-foreground/30 hover:text-primary transition-colors" aria-label="GitHub">
                        <Github size={14} />
                      </a>
                    </div>
                  </div>
