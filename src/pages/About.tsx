        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="lg:w-1/2 relative flex justify-center">
            ...
            >
              ...
              {/* Subtle glow — behind the card only, small */}
              ...
              <div className="glass p-10 rounded-[40px] border border-border space-y-8">
                {specs.map(spec => (
                  <div key={spec.title} className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground font-bold mb-2">{spec.title}</h4>
        ...
        <div className="max-w-5xl mx-auto glass rounded-[54px] p-8 md:p-20 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-20 relative z-10">
            <div className="lg:w-1/3 flex flex-col gap-8">
              <h2 className="text-4xl md:text-5xl font-display font-clash font-bold text-foreground tracking-tight leading-[1.1]">
                {t('contact.title')}<br />
            ...
            <div className="lg:w-2/3">
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <Button type="submit" disabled={isSubmitting} size="md" className="rounded-2xl group" rightIcon={<Send size={18} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />}>
